  ...
  return (
    <div className="animate-in space-y-6">
      ...
      <div className="relative glass-card p-3 rounded-[2.5rem] shadow-2xl shadow-green-100 overflow-hidden">
        {error && (
          <div role="alert" className="absolute top-4 left-4 right-4 sm:left-1/2 sm:right-auto sm:w-auto sm:transform sm:-translate-x-1/2 z-20 px-6 py-3 bg-red-600 text-white rounded-2xl shadow-xl font-bold text-sm">
            {error}
          </div>
        )}
        ...
        >
          ...
          {selectedShop && (
            ...
            >
              <div className="p-4 w-[calc(100vw-2rem)] sm:w-[280px] max-h-[60vh] overflow-y-auto">
                 <div className="flex items-start gap-3 mb-4">
                    <div className="w-10 h-10 bg-green-600 rounded-lg flex items-center justify-center text-white flex-shrink-0">
                       <svg aria-hidden="true" className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" /></svg>
                    </div>
                    <div>
                ...
                <div className="space-y-2.5 mb-5">
                   <div className="flex items-start gap-2 text-[13px] text-gray-600">
                      <svg aria-hidden="true" className="w-4 h-4 text-gray-400 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" /></svg>
                      <span className="font-medium line-clamp-2">{selectedShop.address}</span>
                   </div>
                   <div className="flex items-center gap-2 text-[13px] text-gray-600">
                      <svg aria-hidden="true" className="w-4 h-4 text-gray-400 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" /></svg>
